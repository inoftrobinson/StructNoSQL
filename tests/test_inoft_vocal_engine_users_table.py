...
class UsersTable(BaseTable):
    def __init__(self):
        ...
        super().__init__(table_name="inoft-vocal-engine_accounts-data", region_name="eu-west-2",
...
class TestTableOperations(unittest.TestCase):
    ...
    def test_get_name_of_one_project(self):
        response_data: Optional[str] = self.users_table.model.projects.projectName.query(
    ...
    def test_update_project_name(self):
        response = self.users_table.model.projects.projectName.query(
            key_name="accountId", key_value="5ae5938d-d4b5-41a7-ad33-40f3c1476211",
            query_kwargs={"projectId": "defcc77c-1d6d-46a4-8cbe-506d12b824b7"}
        ).set_update("test2")
    ...
    def test_update_project_data(self):
        ...
        response = self.users_table.model.projects.query(
            key_name="accountId", key_value="5ae5938d-d4b5-41a7-ad33-40f3c1476211",
            query_kwargs={"projectId": "defcc77c-1d6d-46a4-8cbe-506d12b824b7"}
