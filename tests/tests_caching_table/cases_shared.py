...
def test_simple_get_field(self: unittest.TestCase, users_table: DynamoDBCachingTable):
...
def test_set_then_get_field_from_cache(self: unittest.TestCase, users_table: DynamoDBCachingTable):
    users_table.clear_cached_data_and_pending_operations()
...
def test_debug_simple_set_commit_then_get_field_from_database(self: unittest.TestCase, users_table: DynamoDBCachingTable):
    users_table.clear_cached_data_and_pending_operations()
    random_field_value = random.randint(0, 100)
...
def test_update_multiple_fields(self: unittest.TestCase, users_table: DynamoDBCachingTable):
    users_table.clear_cached_data_and_pending_operations()
    random_field_one_value = random.randint(0, 99)
    random_field_two_value = random.randint(100, 199)
...
def test_set_delete_field(self: unittest.TestCase, users_table: DynamoDBCachingTable):
    users_table.clear_cached_data_and_pending_operations()
    random_field_value = random.randint(0, 100)
...
def test_set_remove_field(self: unittest.TestCase, users_table: DynamoDBCachingTable):
    users_table.clear_cached_data_and_pending_operations()
    random_field_value = random.randint(0, 100)
...
def test_dict_data_unpacking(self: unittest.TestCase, users_table: DynamoDBCachingTable):
    """
...
def test_list_data_unpacking(self: unittest.TestCase, users_table: DynamoDBCachingTable):
    """
    Data unpacking handle the scenario where an object would be put in the cache (like a dictionary, that has been
    updated as an object, instead of doing it field per field), and then later on, we try to access from the cache
    one field of packed data. We want to be handle to retrieve data that was packed in bigger object, which means
...
def test_set_remove_multi_selector_field_and_field_unpacking(self: unittest.TestCase, users_table: DynamoDBCachingTable):
    users_table.clear_cached_data_and_pending_operations()
    random_field_one_value = f"field_one_{uuid4()}"
    random_field_two_value = f"field_two_{uuid4()}"
...
def test_set_delete_multiple_fields(self: unittest.TestCase, users_table: DynamoDBCachingTable):
    users_table.clear_cached_data_and_pending_operations()
...
def test_set_remove_multiple_fields(self: unittest.TestCase, users_table: DynamoDBCachingTable):
    users_table.clear_cached_data_and_pending_operations()
    random_field_value_one = random.randint(0, 100)
    random_field_value_two = random.randint(100, 200)
