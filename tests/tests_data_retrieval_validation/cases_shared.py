...
from StructNoSQL import DynamoDBBasicTable, DynamoDBCachingTable, InoftVocalEngineCachingTable, FieldSetter, FieldGetter
...
def test_get_multiple_fields(
    ...
    second_table_retrieved_simple_field: Dict[str, Optional[int]] = second_table.get_multiple_fields(
    ...
    self.assertEqual({'one': None, 'two': None}, second_table_retrieved_simple_field)
