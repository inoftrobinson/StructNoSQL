...
class AbstractContainer:
    ...
    # only use the tests in this file from other class that will properly inherit and initialize the test case by passing it
    # the table_factory argument. We also need to keep the word 'test' out of the filename to avoid being detected as an unittest.
