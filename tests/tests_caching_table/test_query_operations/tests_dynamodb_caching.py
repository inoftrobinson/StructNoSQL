...
class TestDynamoDBCachingTable(unittest.TestCase):
    ...
    def test_set_get_fields_with_overriding_names(self):
        from tests.tests_caching_table.test_query_operations.cases_dynamodb import test_set_get_fields_with_overriding_names
        test_set_get_fields_with_overriding_names(**self.DYNAMODB_CASE_KWARGS)

    def test_set_get_fields_with_multi_selectors(self):
        from tests.tests_caching_table.test_query_operations.cases_dynamodb import test_set_get_fields_with_multi_selectors
    ...
    def test_set_get_multiple_fields_with_special_inner_keys(self):
        from tests.tests_caching_table.test_query_operations.cases_dynamodb import test_set_get_multiple_fields_with_special_inner_keys
